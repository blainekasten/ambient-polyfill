;(function(){
  var video, canvas, threshold = 2, __observing__ = false, 
      createAmbienceDOM, __observe, context, width, height,
      startingThreshold, thresholdSet = false,
      darkerThreshold, lighterThreshold,
      __prevAmbience = 'light', rgbValua;
  ...
  __observe = function(){
    var requestId, _requestAnimationFrame, pixels, d, lightStrength= 0, round = 0;
      ...
      requestId = window.requestAnimationFrame(function() {
        ...
        if (round < 100) round++;
          ...
          if (!thresholdSet) {
            ...
            window.thresholds = {start: startingThreshold, dark: darkerThreshold, light: lighterThreshold}
          }
